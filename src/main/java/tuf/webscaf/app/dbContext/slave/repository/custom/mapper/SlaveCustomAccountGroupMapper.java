...
public class SlaveCustomAccountGroupMapper implements BiFunction<Row, Object, SlaveAccountGroupEntity> {
    MultiValueMap<Long, Long> accGroupMap = new LinkedMultiValueMap<Long, Long>();

    @Override
    public SlaveAccountGroupEntity apply(Row source, Object o) {

        return SlaveAccountGroupEntity.builder()
