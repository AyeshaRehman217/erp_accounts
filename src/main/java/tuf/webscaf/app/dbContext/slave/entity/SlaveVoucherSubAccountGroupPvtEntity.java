...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"voucher_sub_account_groups_pvt\"")
public class SlaveVoucherSubAccountGroupPvtEntity {
    ...
    @Column("sub_account_group_uuid")
    private UUID subAccountGroupUUID;
