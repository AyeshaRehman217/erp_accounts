...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"profit_center_group_profit_center_pvt\"")
public class SlaveProfitCenterGroupProfitCenterPvtEntity {
    ...
    @Column("profit_center_uuid")
    private UUID profitCenterUUID;

    @Column("profit_center_group_uuid")
