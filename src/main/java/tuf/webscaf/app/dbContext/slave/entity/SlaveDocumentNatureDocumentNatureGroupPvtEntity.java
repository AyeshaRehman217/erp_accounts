...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"document_nature_document_nature_group_pvt\"")
public class SlaveDocumentNatureDocumentNatureGroupPvtEntity {
    @Id
    @Column("id")
    @Schema(hidden = true)
    private Long id;
...
//    private Long documentNatureId;
    ...
    @Column("document_nature_group_id")
    private Long documentNatureGroupId;
