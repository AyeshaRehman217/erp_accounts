...
public class SlaveCustomOpeningBalanceAccountDtoMapper implements BiFunction<Row, Object, SlaveOpeningBalanceAccountDto> {

    @Override
    public SlaveOpeningBalanceAccountDto apply(Row source, Object o) {

        return SlaveOpeningBalanceAccountDto.builder()
                ...
                .openingBalance(source.get("openingBalance", BigDecimal.class))
                .openingBalanceDescription(source.get("openingBalanceDescription", String.class))
                .debit(source.get("debit", Boolean.class))
