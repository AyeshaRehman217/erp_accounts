...
public class SlaveCustomCalendarGroupMapper implements BiFunction<Row, Object, SlaveCalendarGroupEntity> {
    MultiValueMap<Long, Long> accGroupMap = new LinkedMultiValueMap<Long, Long>();

    @Override
    public SlaveCalendarGroupEntity apply(Row source, Object o) {

        return SlaveCalendarGroupEntity.builder()
