...
public class SlaveCustomVoucherGroupMapper implements BiFunction<Row, Object, SlaveVoucherGroupEntity> {
    @Override
    public SlaveVoucherGroupEntity apply(Row source, Object o) {

            return SlaveVoucherGroupEntity.builder()
