...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"cash_flow_lines\"")
public class SlaveCashFlowLineEntity {
    @Id
    @Column("id")
    @Schema(hidden = true)
    private Long id;
    ...
    private String lineIntendentation;

    @Column("cash_flow_report_id")
    private Long cashFlowReportId;
