...
public class SlaveCustomJobGroupMapper implements BiFunction<Row, Object, SlaveJobGroupEntity> {
    @Override
    public SlaveJobGroupEntity apply(Row source, Object o) {

            return SlaveJobGroupEntity.builder()
