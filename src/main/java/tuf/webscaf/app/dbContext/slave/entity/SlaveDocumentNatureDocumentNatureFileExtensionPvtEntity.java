...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"document_nature_document_nature_file_extension_pvt\"")
public class SlaveDocumentNatureDocumentNatureFileExtensionPvtEntity {
    @Id
    @Column("id")
    @Schema(hidden = true)
    private Long id;
...
//    @Column("document_nature_id")
//    private Long documentNatureId;

    @Column("document_nature_extension_id")
    private Long documentNatureExtension_id;
