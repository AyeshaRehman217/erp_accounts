...
public class SlaveCustomJobMapper implements BiFunction<Row, Object, SlaveJobEntity> {
    @Override
    public SlaveJobEntity apply(Row source, Object o) {

            return SlaveJobEntity.builder()
