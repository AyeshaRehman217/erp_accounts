...
public class SlaveCustomVoucherMapper implements BiFunction<Row, Object, SlaveVoucherEntity> {
    @Override
    public SlaveVoucherEntity apply(Row source, Object o) {

        return SlaveVoucherEntity.builder()
