...
public class SlaveCustomProfitCenterGroupMapper implements BiFunction<Row, Object, SlaveProfitCenterGroupEntity> {
    @Override
    public SlaveProfitCenterGroupEntity apply(Row source, Object o) {

            return SlaveProfitCenterGroupEntity.builder()
