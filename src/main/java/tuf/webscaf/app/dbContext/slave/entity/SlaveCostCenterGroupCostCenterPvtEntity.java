...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"cost_center_group_cost_center_pvt\"")
public class SlaveCostCenterGroupCostCenterPvtEntity {
    ...
    @Column("cost_center_uuid")
    private UUID costCenterUUID;

    @Column("cost_center_group_uuid")
