...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"voucher_document_nature_group_pvt\"")
public class SlaveVoucherDocumentNatureGroupPvtEntity {
    ...
    @Column("document_nature_group_uuid")
    private UUID documentNatureGroupUUID;
