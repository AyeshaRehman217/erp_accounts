...
public class SlaveCustomCalendarMapper implements BiFunction<Row, Object, SlaveCalendarEntity> {
    @Override
    public SlaveCalendarEntity apply(Row source, Object o) {

            return SlaveCalendarEntity.builder()
