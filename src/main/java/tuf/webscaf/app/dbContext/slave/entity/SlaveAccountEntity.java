...
public class SlaveAccountEntity {
    ...
    @Column("is_entry_allowed")
    private Boolean isEntryAllowed;

    @Column("account_type_uuid")
    private UUID accountTypeUUID;

    @Column("parent_account_uuid")
    private UUID parentAccountUUID;

    @Column("is_opening_balance")
    private Boolean isOpeningBalance;

    @Column("opening_balance_uuid")
