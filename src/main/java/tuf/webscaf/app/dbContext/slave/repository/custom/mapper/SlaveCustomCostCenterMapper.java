...
public class SlaveCustomCostCenterMapper implements BiFunction<Row, Object, SlaveCostCenterEntity> {
    @Override
    public SlaveCostCenterEntity apply(Row source, Object o) {

        return SlaveCostCenterEntity.builder()
