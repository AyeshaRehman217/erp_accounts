...
public class SlaveCustomAccountMapper implements BiFunction<Row, Object, SlaveAccountEntity> {

    @Override
    public SlaveAccountEntity apply(Row source, Object o) {

        return SlaveAccountEntity.builder()
