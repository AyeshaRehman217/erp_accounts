...
public class SlaveCustomCostCenterGroupMapper implements BiFunction<Row, Object, SlaveCostCenterGroupEntity> {
    @Override
    public SlaveCostCenterGroupEntity apply(Row source, Object o) {

            return SlaveCostCenterGroupEntity.builder()
