...
import tuf.webscaf.app.dbContext.slave.repository.custom.contract.SlaveCustomCostCenterGroupWithVoucherRepository;
import tuf.webscaf.app.dbContext.slave.repository.custom.mapper.SlaveCustomVoucherMapper;

import java.util.UUID;

public class SlaveCustomCostCenterGroupWithVoucherRepositoryImpl implements SlaveCustomCostCenterGroupWithVoucherRepository {
    private DatabaseClient client;
    private SlaveVoucherEntity slaveVoucherEntity;

    @Autowired
    public SlaveCustomCostCenterGroupWithVoucherRepositoryImpl(@Qualifier("slave") ConnectionFactory cf) {
        this.client = DatabaseClient.create(cf);
    }

    @Override
    public Flux<SlaveVoucherEntity> showMappedVouchersAgainstCostCenterGroup(UUID costCenterGroupUUID, String name, String dp, String d, Integer size, Long page) {
    ...
    @Override
    public Flux<SlaveVoucherEntity> showMappedVouchersAgainstCostCenterGroupWithStatus(UUID costCenterGroupUUID, Boolean status, String name, String dp, String d, Integer size, Long page) {
