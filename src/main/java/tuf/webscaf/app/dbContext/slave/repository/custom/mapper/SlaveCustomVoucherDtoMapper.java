...
public class SlaveCustomVoucherDtoMapper implements BiFunction<Row, Object, SlaveVoucherDto> {
    @Override
    public SlaveVoucherDto apply(Row source, Object o) {

        return SlaveVoucherDto.builder()
                ...
                .voucherTypeCatalogueUUID(source.get("voucher_type_catalogue_uuid", UUID.class))
                .voucherTypeCatalogueSlug(source.get("slug", String.class))
