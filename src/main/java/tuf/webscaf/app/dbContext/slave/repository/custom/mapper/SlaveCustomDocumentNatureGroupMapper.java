...
public class SlaveCustomDocumentNatureGroupMapper implements BiFunction<Row, Object, SlaveDocumentNatureGroupEntity> {
    @Override
    public SlaveDocumentNatureGroupEntity apply(Row source, Object o) {

            return SlaveDocumentNatureGroupEntity.builder()
