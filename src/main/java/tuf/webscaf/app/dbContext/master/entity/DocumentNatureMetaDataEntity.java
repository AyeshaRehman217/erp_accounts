...
@Getter
@Setter
@Table("public.\"document_nature_meta_datas\"")
public class DocumentNatureMetaDataEntity {
    @Id
    @Column("id")
    @Schema(hidden = true)
    private Long id;
...
//    private Long documentNatureId;
    ...
    @Column("document_nature_meta_field_id")
    private Long documentNatureMetaFieldId;
