...
// String profitCenter, String code, Double totalCredit, Double totalDebit
    public CostCenterEntity(int id, String code, String name, String description, String center, String profitCenter, String debit, String credit) {
        this.id = (long) id;
        this.name = name;
