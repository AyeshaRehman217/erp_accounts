...
public class StoreBalanceAndIncomeLineHandlerFilter implements HandlerFilterFunction<ServerResponse, ServerResponse> {
...
//                    if (request.headers().firstHeader("auid").isEmpty()) {
//                        messages.add(
//                                new AppResponseMessage(
//                                        AppResponse.Response.ERROR,
//                                        "Unknown User"
