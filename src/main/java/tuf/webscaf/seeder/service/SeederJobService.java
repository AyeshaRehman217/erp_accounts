...
public class SeederJobService {
    ...
    public Mono<ServerResponse> seedJobData(String url){

        ArrayList<MultiValueMap<String, String>> list = new ArrayList<>();
        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Convocation");
        formData.add("description", "Convocation job description");
        ...
        formData1.add("name", "Job Fair");
        formData1.add("description", "Alumni job description");
        ...
        formData2.add("name", "Supports Gala");
        formData2.add("description", "Admission job description");
