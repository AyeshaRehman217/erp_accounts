CREATE TABLE public.document_nature_document_nature_file_extension_pvt
(
    id bigint NOT NULL GENERATED ALWAYS AS IDENTITY,
    version bigint,
    uuid uuid DEFAULT gen_random_uuid(),
    document_nature_id bigint,
    document_nature_extension_id bigint,
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (document_nature_extension_id)
        REFERENCES public.document_nature_file_extensions (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);
