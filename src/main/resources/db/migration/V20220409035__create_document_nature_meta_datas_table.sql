CREATE TABLE public.document_nature_meta_datas
(
    ...
    document_nature_meta_field_id bigint,
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (document_nature_meta_field_id)
        REFERENCES public.document_nature_meta_fields (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);